...
<body class="bg-info dker">
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
      <a class="navbar-brand block" href="index.php"><span class="h1 font-bold">Musik</span></a>
      <section class="m-b-lg">
        ...
        <form action="hasil_login.php" method="POST">
          ...
          <a href="<?php echo site_url('Auth') ?>" class="btn btn-lg btn-info btn-block rounded">Create an account</a>
        </form>
      </section>
    </div>
  </section>
